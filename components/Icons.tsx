...
// Reverted Logo to a cleaner, simpler symbol
...
export const DeviceIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const DiscordIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M2 12c0 5 2.5 9 10 9s10-4 10-9-5-10-10-10-10 5-10 10Z" />
  </svg>
);
...
export const PenToolIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const MoreHorizontalIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const CheckSquareIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const UmbrellaIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const SmileIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="12" cy="12" r="10" />
...
export const FileInputIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const QuoteIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H6c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z" />
    <path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-2c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z" />
  </svg>
);

// --- Brand Icons ---

export const WeChatIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M8 12.13c0-2.4 2.13-4.43 4.9-4.43 2.76 0 5 2.03 5 4.43 0 2.44-2.2 4.46-5 4.46a6.8 6.8 0 0 1-1.63-.2l-2.07 1.1c-.26.15-.47.11-.47-.13v-1.7c-1.87-1.47-2.9-3.23-2.9-5.13m-6.4 7.23c0 2.1 1.9 3.86 4.3 3.86.53 0 1.05-.1 1.54-.28v1.36c0 .2.18.25.4.13l1.83-1.03c1.5 1.05 3.1 1.25 4.3.08l.1-.08c-3.13-.13-5.6-2.58-5.6-5.6 0-1.12.34-2.17.93-3.08a6 6 0 0 0-4.3 1.23v1.37c0 .24-.2.28-.46.13l-1.8-1.03a6.1 6.1 0 0 0-1.46.2 3.82 3.82 0 0 0 4.1-3.6" />
...
export const XiaohongshuIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M20 5c-1.1 0-2 .9-2 2v1h-1v-1c0-1.1-.9-2-2-2h-1V3h-2v2h-1V3H9v2H8V3H6v2H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 14H5V7h14v12z" />
    <path d="M7 9h10v2H7zM7 13h10v2H7z" />
  </svg>
);

export const YouTubeIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M21.58 7.17a2.72 2.72 0 0 0-1.91-1.92C17.98 4.8 12 4.8 12 4.8s-5.98 0-7.67.45a2.72 2.72 0 0 0-1.91 1.92C2 8.87 2 12.4 2 12.4s0 3.53.42 5.23a2.72 2.72 0 0 0 1.91 1.92c1.69.45 7.67.45 7.67.45s5.98 0 7.67-.45a2.72 2.72 0 0 0 1.91-1.92c.42-1.7.42-5.23.42-5.23s0-3.53-.42-5.23zM9.6 15.2V9.6l5.4 2.8-5.4 2.8z" />
  </svg>
);

export const DouyinIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
     <path d="M17.5 2.5a.5.5 0 0 0-.5.5v3.5a.5.5 0 0 1-.5.5c-1.1 0-2.2-.4-3-1.1v9.1c0 2.2-1.8 4-4 4s-4-1.8-4-4 1.8-4 4-4c.6 0 1.2.1 1.7.3.3.1.5-.1.5-.4V8.5c0-.3-.2-.5-.5-.5-.5-.1-1.1-.1-1.7-.1-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6V6c0-1.1 2.2-2 4.5-2 .3 0 .5-.2.5-.5V2.5z"/>
  </svg>
);

export const BilibiliIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M18.7 6.7H5.3c-1.1 0-2 .9-2 2v8.6c0 1.1.9 2 2 2h13.4c1.1 0 2-.9 2-2V8.7c0-1.1-.9-2-2-2zM8 15.3c-.7 0-1.3-.6-1.3-1.3s.6-1.3 1.3-1.3 1.3.6 1.3 1.3-.6 1.3-1.3 1.3zm8 0c-.7 0-1.3-.6-1.3-1.3s.6-1.3 1.3-1.3 1.3.6 1.3 1.3-.6 1.3-1.3 1.3zM8.5 4.8l1.3 1.9H12L9.5 4.3c-.2-.2-.5-.1-.6.1-.2.2-.1.5.1.6zm6-1.1l-2.5 2.4h2.2l1.3-1.9c.2-.2.2-.5.1-.6-.2-.2-.5-.1-.6.1z"/>
  </svg>
);